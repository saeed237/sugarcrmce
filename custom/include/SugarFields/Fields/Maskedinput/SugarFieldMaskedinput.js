//100% of credit belongs to dswitzer at http://www.pengoworks.com/workshop/js/mask/
//Please send your thanks that direction. Also note the documenation on that page. 
//
//Modified slightly by dmarks, although I'm not sure exactly where all my modifications are
//-the special char 'x' is now '@' instead.
//  ie/ '@@@' would be a mask for ABC, but not 123.
//-tweaks to get date formatting to work better.
/*
//apply a mask to a textbox like so:
var oStringMask = new Mask("mm/dd/YYYY");
oStringMask.attach(document.getElementById("myTextBox_domID"));
*/
function _MaskAPI(){
	this.version = "0.4a";
	this.instances = 0;
...
Mask.prototype.setGeneric = function (_v, _d){
	...
	var r = "@#*Aa", rt = [], nv = "", t, x, a = [], j=0, rx = {"@": "A-Za-z","#": "0-9", "*": "A-Za-z0-9", "A": "A-Z", "a": "a-z" }; // removed this definition of 'x' as a valid char
...
qEvent.prototype.setKeyPressed = function (i){
	...
	switch( i ){
		...
		case 17: case 57390: return this.setKP(i, "[ctrl]");d
